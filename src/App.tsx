...
function getToolIcon(toolId: string, activeCount: number) {
  ...
  switch (toolId.toLowerCase()) {
    case 'codex':
      // GitHub Copilot / Codex exact official icon
      return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style={{ color, marginRight: '0.4rem' }}>
    ...
    case 'claudecode':
      // Anthropic Claude exact official icon
      return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style={{ color, marginRight: '0.4rem' }}>
    ...
    case 'antigravity':
      // Google Gemini exact official icon
      return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style={{ color, marginRight: '0.4rem' }}>
